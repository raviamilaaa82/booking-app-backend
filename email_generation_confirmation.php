...
function generateConfirmEmail($connection, $new_id): bool
{
  $query = "
    SELECT 
    b.event_title,
...
GROUP BY b.id
  ...
  $is_allDay = $data['is_all_day'];


  if ($data) {
    if ($is_allDay) {
      return sendMail($customer_email, $full_name, $sport_name, $booking_date, $event_title, "All Day", $booking_price, $new_id);
    } else {
      return sendMail($customer_email, $full_name, $sport_name, $booking_date, $event_title, $time_slots, $booking_price, $new_id);
    }
  } else {
    return false;
  }
...
function sendMail($to_mail, $full_name, $sport, $booking_date, $booking_title, $time_slot, $booking_price, $booking_id): bool
{
          ...
          <tr>
            <td style='padding:40px 40px 32px;'>
              ...
              <p style='font-size:15px;color:#aaaaaa;line-height:1.8;margin:0 0 32px 0;'>
               ...
               verified your booking request for $sport on $booking_date.
              </p>
...
If you have any questions or need to make a change to your request, simply call us at  <strong style='color:#f5f5f5;'>077-777-7777</strong>.
</p>
                  </td>
                  </tr>
              </table> 
